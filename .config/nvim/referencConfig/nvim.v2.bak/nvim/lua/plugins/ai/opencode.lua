return {
  ...
  keys = {
    ...
    { "<leader>ai",  desc = "Open Opencode input" },
    { "<leader>aI",  desc = "Open input (new session)" },
    { "<leader>ao",  desc = "Open Opencode output" },
    { "<leader>at",  desc = "Toggle Opencode focus" },
    { "<leader>aT",  desc = "Opencode timeline" },
    { "<leader>aq",  desc = "Close Opencode" },
    { "<leader>as",  desc = "Select Opencode session" },
    { "<leader>aR",  desc = "Rename Opencode session" },
    { "<leader>ap",  desc = "Configure provider" },
    { "<leader>aV",  desc = "Configure variant" },
    { "<leader>ay",  desc = "Add visual selection",     mode = "v" },
    { "<leader>az",  desc = "Toggle Opencode zoom" },
    { "<leader>av",  desc = "Paste image" },
    { "<leader>ad",  desc = "Diff open" },
    { "<leader>a]",  desc = "Diff next" },
    { "<leader>a[",  desc = "Diff prev" },
    { "<leader>ac",  desc = "Diff close" },
    { "<leader>ara", desc = "Revert all (last prompt)" },
    { "<leader>art", desc = "Revert this (last prompt)" },
    { "<leader>arA", desc = "Revert all (session)" },
    { "<leader>arT", desc = "Revert this (session)" },
    { "<leader>arr", desc = "Restore snapshot file" },
    { "<leader>arR", desc = "Restore snapshot all" },
    { "<leader>ax",  desc = "Swap Opencode position" },
    { "<leader>att", desc = "Toggle tool output" },
    { "<leader>atr", desc = "Toggle reasoning output" },
    { "<leader>a/",  desc = "Quick chat",               mode = { "n", "x" } },
  },
  dependencies = {
  ...
  config = function()
    require("opencode").setup({
      auto_confirm = false,             -- For asking before trying to add changes in codebase
      require_approval = true,          -- For asking the approval of the user for running shell commands
